...
<div class="row">
  <div class="col-md-6">
    ...
    <?= $form->field($model, 'is_fraud')->dropdownList(['0' => 'No', '1' =>  'Yes']) ?>

  </div>
  <div class="col-md-6">
    <?= $form->field($model, 'category_id')->dropdownList(
     ArrayHelper::map(Category::find()->all(), 'id', 'category_name'),['prompt' => 'Select Category...']) ?>


    <?= $form->field($model, 'is_urgent')->dropdownList(['0' => 'Normal', '1' =>  'High']) ?>
  </div>
</div>
