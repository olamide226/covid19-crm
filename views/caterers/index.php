...
<form class="" action="" method="get">
  ...
  <input type="hidden" name="r" value="caterers/apiview">
  <input type="text" pattern="\d{10,11}" name="myphone" required placeholder="Enter phone..." value="">
  <button type="submit" class="btn btn-secondary">API Search</button>
</form><br>
<?php Pjax::begin()?>
    <?= GridView::widget([
 ...
 <?php if ((User::hasRole('supervisor') || User::hasRole('admin') || User::hasRole('boiBackendTeam') ) && !isset($_GET['CaterersSearch'])) :
 ?>
