...
<div class="panel panel-success">
  <div class="panel-heading"><h5> Log a new conversation.</h5></div>
    ...
    <?= $form->field($calllogs, 'phone_no')->textInput(['value'=> $phone_no,
    ...
    <?= $form->field($calllogs, 'member_id')->hiddenInput(['value' =>$phone_no,
                                                        'readonly' => true])->label(false) ?>
    <?= $form->field($calllogs, 'account_no')->hiddenInput(['value'=> '','maxlength'=>true])->label(false) ?>
    ...
    <!--?= $form->field($calllogs, 'fraud_status')->dropdownList([
      ...
      <?= $form->field($calllogs, 'cbrid')->hiddenInput(['value' => $cbr ? $cbr['Id'] : 0,
                                                        'readonly' => true])->label(false) ?>
