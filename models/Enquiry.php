...
class Enquiry extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_name', 'comment_id','phone_no',  'user_id','product_id', 'entry_source_id','cc_agent_response'], 'required'],
            [['entry_date','comment_id', 'lga_id','sub_category','ticket_number'], 'safe'],
