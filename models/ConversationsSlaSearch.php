 ...
 */
class ConversationsSlaSearch extends Conversations
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['comment_id', 'state_id', 'other_comment','usergroup', 'user_id', 'entry_date', 'amount_paid', 'entry_source_id', 'entry_category', 'agent_name', 'date_paid', 'member_id', 'fraud_status', 'cc_agent_action'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        $query = Conversations::find();
            ...
            $query->innerJoin("ecrm_sla", "sla_id = ecrm_sla.id");
        ...
        $query->andFilterWhere([
            ...
            'ecrm_conversations.sla_urgency' => $this->sla_urgency,
            // 'ecrm_sla.user_group' => '{get_user_group(' . Yii::$app->user->id  . ')}',
            // 'ecrm_sla.user_group' => '{get_user_group(' . Yii::$app->user->id  . ')}',
            'ecrm_sla.user_group' => $this->userGroup(Yii::$app->user->id),
            // 'user_id' => $this->user_id,
            // 'user.username' => $this->user_id,
            'ecrm_conversations.category_id' => $this->category_id,
            'ecrm_conversations.product_id' => $this->product_id,
        ]);
