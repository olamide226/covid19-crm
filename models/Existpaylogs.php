 ...
 */
class Existpaylogs extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_name', 'comment_id',  'user_id','product_id', 'entry_source_id','entry_category', 'ticket_status', 'cc_agent_response'], 'required'],
