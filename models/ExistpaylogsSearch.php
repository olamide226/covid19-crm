...
/**
 * PaylogsSearch represents the model behind the search form of `app\models\Paylogs`.
 */
class ExistpaylogsSearch extends Enquiry
{
  public $username;
    /**
     * @inheritdoc
    ...
    public function rules()
    {
        return [
            [['id',], 'integer'],
            [['customer_name', 'phone_no','username', 'entry_date','state_id', 'association', 'comment_id', 'other_comment', 'cc_agent_response', 'user_id', 'entry_source_id', 'cc_agent_action','category_id', 'ticket_number','ticket_status', 'amount_paid', 'date_paid',], 'safe'],
        ];
    }
