...
/**
 * CatererSearch represents the model behind the search form of `app\models\Caterer`.
 */
class CatererSearch extends Caterer
{
  public $username;
    /**
     * @inheritdoc
    ...
    public function rules()
    {
        return [
            [['id',], 'integer'],
            [['customer_name', 'phone_no','username', 'entry_date','state_id', 'association', 'comment_id', 'other_comment', 'cc_agent_response', 'user_id', 'entry_source_id', 'cc_agent_action','category_id'], 'safe'],
        ];
    }
