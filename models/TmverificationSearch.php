...
/**
 * TmverificationSearch represents the model behind the search form of `app\models\Tmverification`.
 */
class TmverificationSearch extends Tmverification
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['candidateid', 'phone', 'batch_id', 'status', 'reason'], 'integer'],
            [['firstname', 'lastname', 'middlename', 'gender', 'dob', 'bvn', 'tradetype', 'trade_subtype_name', 'home_address', 'date_enumerated', 'current_bank', 'account_number', 'state', 'lga', 'cluster_location', 'trademoni_id', 'agent_firstname', 'agent_lastname', 'agent_middlename', 'valid_rating','user_id', 'created_on'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'firstname', $this->firstname])
            ...
            ->andFilterWhere(['like', 'valid_rating', $this->valid_rating]);
