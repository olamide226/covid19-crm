...
class EnquiryController extends Controller
{
    ...
    public function actionCallRecords()
    {
      $myvar = $_REQUEST['q'];
      $conn = \Yii::$app->getDb();
      $sql = sprintf("SELECT a.entry_date, concat(b.first_name, ' ', b.last_name) usernam, c.comments,a.other_comment, a.cc_agent_response, a.sub_category
...
public function actionExcel()
{
        ...
        if (isset($_POST['submit'])){
            ...
            $file_name = 'Enquiry_Report_' . date('Y-m-d') . '.csv';
